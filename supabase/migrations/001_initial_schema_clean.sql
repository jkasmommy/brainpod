-- BrainPod Database Schema - Clean Migration
...
DROP POLICY IF EXISTS "Users can view own learner profiles" ON public.learner_profiles;
...
DROP POLICY IF EXISTS "Users can view own learner notes" ON public.learner_notes;
DROP POLICY IF EXISTS "Users can view own learner achievements" ON public.learner_achievements;
...
DROP TRIGGER IF EXISTS update_skill_mastery_updated_at ON public.skill_mastery;
DROP TRIGGER IF EXISTS update_learner_notes_updated_at ON public.learner_notes;
